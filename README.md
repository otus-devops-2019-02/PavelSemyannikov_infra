...
При вызове скрипта "./inventory.py --list" возвращаеться json со списком хостов по группам app, db 
и others (в others хосты не попавшие в другие группы). Пустые группы не возвращаются.
